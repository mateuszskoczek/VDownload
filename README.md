...
| `info <link> [options]`      | Informations about video (metadata and available streams) or playlist<br><br>Options:<br>`--video=<id>` (show informations about video with specified id [YP])                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `download <link> [options]`  | Download video<br><br>Options:<br>`--onlyvideo` (download only video [YS &#124; YP])<br>`--onlyaudio` (download only audio [YS &#124; YP])<br>`--video=<id>` (download video stream with specified id; best if not specified [YS])<br>`--audio=<id>` (download audio stream with specified id; best if not specified [YS])<br>`--output_path=<path>` (output file path [YS &#124; YP])<br>`--filename=<filename>` (filename; template [YS &#124; YP])<br>`--video_ext=<extension>` (video file extension [YS &#124; YP])<br>`--audio_ext=<extension>` (audio file extension [YS &#124; YP]) |
